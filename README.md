...
Actual standalone Coach Studio UI from the `feat/settings-subtabs` worktree, rendered through a local admin server with a temporary on-disk Store. No production account or customer data. The update endpoint was stubbed; these screenshots do not prove an installed production upgrade.
